...
function Footer() {
  return (
    <footer
      style={{ backgroundColor: "rgb(250, 250, 250)", marginBottom: "20px" }}
    >
      <div className="container border-top mt-5">
        <div className="row mt-5">
          ...
          <div className="col">
            ...
            <a href="/" className="d-inline-block mb-2 text-decoration-none text-muted">
              Open demat account
            </a>
            <br />
            <a href="/" className="d-inline-block mb-2 text-decoration-none text-muted">
        ...
        <div className="col text-muted d-flex justify-content-center flex-wrap gap-3">
