            ...
            <div className='row p-5'>
                ...
                <div className='col-6 p-5'>
                    ...
                    <div className='text-center'>
                        <a href='/' className='mx-5' style={{textDecorationLine: 'none'}}>Explore our products <i class="fa-solid fa-arrow-right-long"></i> </a>
                        <a href='/'  style={{textDecorationLine: 'none'}}>Try Kite demo <i class="fa-solid fa-arrow-right-long"></i> </a>
                    </div>
                </div>
            </div>
       </div>
